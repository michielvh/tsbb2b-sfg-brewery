...
//passing in Controller with webMVC
//vs declaring it as variable and @InjectMocks
...
class BeerControllerTest {
    ...
    // inject instance of mockMvc which has been configured by spring framework
    //before we had to build mockMvc with builder including controller
    @Autowired
    MockMvc mockMvc;
